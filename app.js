...
const quotes = [
    ...
    {quote:"Your mind is like this water, my friend. When it is agitated, it becomes difficult to see. But if you allow it to settle, the answer becomes clear",person:"Master Ooqway"},
    {quote:"There are no accidents",person:"Master Ooqway"},
    ...
    {quote:"",person:""},
    {quote:"Use your skills for good, young warrior. Find the one thing you were denied so long ago — compassion.",person:"Master Ooqway"}
];
